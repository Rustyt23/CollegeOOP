//14		Write a C++ program  where we are taking the objects as data types and set the two distance  values and display the result as the addition of these two distances ( object as a data type )?
#include  <iostream>
using namespace std;
